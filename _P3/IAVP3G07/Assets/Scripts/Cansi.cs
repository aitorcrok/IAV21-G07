...
namespace BehaviorDesigner.Runtime.Tasks.Tutorials
{
    ...
    public class Cansi : MonoBehaviour
    {
        ...
        public void Update()
        {
            visible = WithinSight(targetObject.Value, fieldOfViewAngle.Value, viewDistance.Value);
        }
        ...
        public void OnDrawGizmos()
        {
            ...
            UnityEditor.Handles.DrawSolidArc(transform.position, transform.up, beginDirection, fieldOfViewAngle.Value, viewDistance.Value);
